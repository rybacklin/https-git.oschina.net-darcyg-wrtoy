...
/* Update Log(joykicer@gmail.com 2014-01-22):
 * 1. Send firmware with 256*1024 bytes per package
 * 2. Read and check device response after send cmd
 * 3. Use 0x7d as an escape character encode package
 */
